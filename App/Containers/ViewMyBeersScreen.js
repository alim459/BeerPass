...
class ViewMyBeersScreen extends React.Component {
  ...
  *************************************************************/
  renderRow (rowData) {
    ...
    //   if (rowData[key].startsWith(this.props.searchTerm)) {
      console.log("in renderRow, props are" + JSON.stringify(this.props))
        return (
          <View style={styles.row}>
            <Text style={styles.boldLabel}>{rowData.name}</Text>
            <Text style={styles.label}>{rowData.brewery}</Text>
          </View>
        )
    //   }
    // }
  ...
  *************************************************************/
  ...
  render () {
    console.log("currently, in render, props are " + JSON.stringify(this.props))
    return (
...
export default connect(mapStateToProps)(ViewMyBeersScreen)
